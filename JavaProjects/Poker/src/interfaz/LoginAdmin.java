...
/**
 *Ventana para el login del administrador 
...
public class LoginAdmin extends javax.swing.JFrame {
    ...
    public LoginAdmin(CasaApuestas reg) {
        initComponents();
        this.reg=reg;
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try{
            //Comprueba que la contraseña coincida con la dada
            String nif= "admin";
            String contrasenna = "admin";
            String pass= new String(txtPass.getPassword());
            if ((nif.equals(txtNif.getText()))&&(contrasenna.equals(pass))){
                Administrador jFrame= new Administrador(reg);
