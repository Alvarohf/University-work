...
<<Kmedoids, fig=TRUE, width=10, height=10>>=
...
<<kmedian, fig=TRUE, width=10, height=10>>=
par(mfrow=c(2,1))
...
<<dbscan, fig=TRUE, width=10, height=10>>=
...
@
<<hc, fig=TRUE, width=10, height=10>>=
...
@
<<hk, fig=TRUE, width=10, height=10>>=
